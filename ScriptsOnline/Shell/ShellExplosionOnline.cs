...
public class ShellExplosionOnline : NetworkBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        for (int i = 0; i < colliders.Length; i++)
        {
            ...
            TankHealthOnline targetHealth = targetRigidbody.GetComponent<TankHealthOnline>();

            // If there is no TankHealthOnline script attached to the gameobject, go on to the next collider.
            if (!targetHealth)
                continue;
