...
{
    static public GameManagerOnline s_Instance;

    //this is static so tank can be added even withotu the scene loaded (i.e. from lobby)
    static public List<TankManagerOnline> m_Tanks = new List<TankManagerOnline>();             // A collection of managers for enabling and disabling different aspects of the tanks.

    public int m_NumRoundsToWin = 5;          // The number of rounds a single player has to win to win the game.
    public float m_StartDelay = 3f;           // The delay between the start of RoundStarting and RoundPlaying phases.
    public float m_EndDelay = 3f;             // The delay between the end of RoundPlaying and RoundEnding phases.
    public CameraControlOnline m_CameraControl;     // Reference to the CameraControl script for control during different phases.
    ...
    private TankManagerOnline m_RoundWinner;          // Reference to the winner of the current round.  Used to make an announcement of who won.
    private TankManagerOnline m_GameWinner;           // Reference to the winner of the game.  Used to make an announcement of who won.
    ...
    {
        TankManagerOnline tmp = new TankManagerOnline();
        tmp.m_Instance = tank;
    ...
    {
        TankManagerOnline toRemove = null;
    ...
    private TankManagerOnline GetRoundWinner()
    {
        // Go through all the tanks...
        for (int i = 0; i < m_Tanks.Count; i++)
        {
    ...
    private TankManagerOnline GetGameWinner()
    {
        int maxScore = 0;
